...
## 🔜 Lopende onderwerpen
- [ ] Diepgaande PPP-scan van `index.html`: elk scherm/elke feature langslopen en toetsen aan alle criteria (functioneel + technisch per pijler, incl. privacy). Aanleiding: PPP-principe is 01-08-2026 aangescherpt.
